...
longVideoSchema.index({ author: 1 });
longVideoSchema.index({ createdAt: -1 });
longVideoSchema.index({ likes: 1 });
longVideoSchema.index({ views: 1 });
longVideoSchema.index({ category: 1 });
longVideoSchema.index({ tags: 1 });
longVideoSchema.index({ privacy: 1 });
longVideoSchema.index({ scheduledAt: 1 });
longVideoSchema.index({ author: 1, createdAt: -1 }); // Compound index for user posts
longVideoSchema.index({ category: 1, createdAt: -1 }); // Compound index for category feeds
longVideoSchema.index({ 
  title: 'text', 
  description: 'text' 
